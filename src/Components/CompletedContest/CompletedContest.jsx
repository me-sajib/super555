...
export default function CompletedContest() {
    ...
    return (
        <>
            <div className='text-center bg-gray-800 text-white py-2'>
                ...
                <h2 className='text-xs text-center my-2'>Contest has been completed</h2>
            </div>
            <Box sx={{ width: '100%', typography: 'body1', marginBottom: '300px' }}>
                <TabContext value={value}>
                    ...
                    <TabPanel value='1'>
                        <div className='pb-60'>
                            <h2 className='text-xs'>The contest has been completed. You cannot participate in completed contest</h2>
                                    ...
                                    return (
                                        <div className='flex border-4 rounded-lg my-4'>
                                            ...
                                            <div className='w-60 p-2'>
                                                {answer.question} {answer.answer === answer.userAnswer ? <span className='text-green-600 font-bold'>(+{answer.correctScore})</span> : <span className='text-red-600 font-bold'>(-{answer.incorrectScore})</span>}
                                                <br />
                                                    ...
                                                    return (
                                                        <tr key={eachUser.rank + Math.random()}>
                                                            <td className='border p-2'>
                                                                ...
                                                                <div className='text-xs text-green-800 font-bold'>Won {eachUser.prize || `${eachUser.coins} coins`}</div>
                                                            </td>
                                                            <td className='border p-2 text-center'>{eachUser.score}</td>
                                                            <td className='border p-2 text-center'>{eachUser.rank}</td>
                                                        </tr>
                                                    )
                                                })}
                                        </tbody>
